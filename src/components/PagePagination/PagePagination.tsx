...
export const PagePagination = () => {
	const { theme, currentPage, filteredCountries, pageSize } = useAppSelector((state) => state.countries);
			...
			<ConfigProvider
				theme={{
					token: {
						...
						colorBgTextHover: theme === 'dark' ? 'hsl(209, 23%, 22%)' : 'hsl(207, 26%, 90%)',
					},
					components: {
						Pagination: {
							itemActiveBg: theme === 'dark' ? 'hsl(209, 23%, 22%)' : 'hsl(207, 26%, 90%)',
							itemSize: 40,
						},
					},
				}}
